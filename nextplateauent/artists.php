...
//query all artists
$text = "SELECT featured.artists_a_id, artists.name, artists.photo FROM artists, featured WHERE artists.a_id=featured.artists_a_id ORDER BY featured.n";
...
<title>Next Plateau Entertainment | Featured Artists</title>
