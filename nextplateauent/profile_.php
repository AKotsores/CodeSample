...
<div style="width:974px; margin:0px auto; padding-top:28px">
	<div style="width:974px; height:60px">
    	<div style="width:623px; height:50px; float:left; background-image:url(images/tab-artist.png); padding-top:10px; padding-left:20px; color:#fff; font-size:35px; font-family:'Oswald', sans-serif"><?php echo $name; ?></div>
    ...
    <div style="width:643px; height:<?php echo round($releases_num_rows/2)*385 ?>px; margin-right:331px;">
        <div style="width:643px; height:356px; margin-right:331px; margin-bottom:20px">
            ...
            <div style="width:270px; height:316px; padding:20px; background-color:#E6E7E8; float:left">
                ...
                <?php if(!empty($iTunes[$i])) { ?><div style="padding-top:6px; width:110px; float:left"><a href="<?php echo $iTunes[$i]; ?>" target="_blank"><img src="images/button-itunes-large.png" width="110" height="40"></a></div><?php } ?>
