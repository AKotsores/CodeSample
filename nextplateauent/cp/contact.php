...
<div style="width:974px; height:550px; margin:0px auto">
	<div style="width:647px; height:23px; padding-top:17px; float:left; color:#58595B; border-bottom:#D71F30 solid 2px; font-family:'Oswald', sans-serif; line-height:17px; font-size:18px">CONTACT FORM</div>
    <div style="width:313px; height:23px; padding-top:17px; float:right; color:#58595B; border-bottom:#D71F30 solid 2px; font-family:'Oswald', sans-serif; line-height:17px; font-size:18px">NEXT PLATEAU</div>
    <div style="width:647px; height:480px; padding-top:30px; float:left; line-height:18px; font-size:14px">
    ...
    <input name="Name" type="text" style="width:456px; height:31px; border:#A7A9AC 1px solid; color:#A7A9AC; font-size:14px; padding-left:9px; padding-right:9px" value="<?php echo $name; ?>" onClick="clearField(this, '<?php echo $name; ?>')" onBlur="recallField(this, '<?php echo $name; ?>')">
    <div style="height:25px"></div>
    <input name="Email" type="text" style="width:456px; height:31px; border:#A7A9AC 1px solid; color:#A7A9AC; font-size:14px; padding-left:9px; padding-right:9px" value="<?php echo $email; ?>" onClick="clearField(this, '<?php echo $email; ?>')" onBlur="recallField(this, '<?php echo $email; ?>')">
    <div style="height:25px"></div>
    <textarea name="Message" style="width:627px; height:107px; border:#A7A9AC 1px solid; color:#A7A9AC; font-size:14px; padding:9px" onClick="clearField(this, '<?php echo $body; ?>')" onBlur="recallField(this, '<?php echo $body; ?>')"><?php echo $body; ?></textarea>
    <div style="height:25px"></div>
    ...
    <div style="width:313px; height:480px; padding-top:30px; float:right; line-height:18px; font-size:14px">
    ...
    <b>License Requests</b><br>
    <a href="mailto:eddieosongs@nextplateauent.com?subject=License Requests">eddieosongs@nextplateauent.com</a><br><br>
...
<div style="height:357px; margin-bottom:30px">
