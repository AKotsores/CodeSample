...
<?php if($output_form) { ?>
        ...
        <div style="width:372px; height:73px; float:left"><input name="Email" type="text" value="<?php echo $email; ?>" onClick="clearField(this, '<?php echo $email; ?>')" onBlur="recallField(this, '<?php echo $email; ?>')" maxlength="47" style="width:350px; height:28px; border:#A7A9AC solid 1px; color:#939598; font-family:'Karla', sans-serif; font-size:14px; font-style:italic; padding-left:10px; padding-right:10px">
